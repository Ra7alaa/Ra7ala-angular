...
export class TripsService {
  ...
  getAllTrips(page = 1, pageSize = 6): Observable<PaginatedResponse> {
  ...
  private trips: Trip[] = [
    {
      ...
      description:
        "Explore the pyramids, Egyptian Museum, and Khan el-Khalili bazaar. Experience the rich history and culture of Egypt's capital city.",
      price: 150,
      imageUrl: 'cairo1.jpg',
    ...
    },
    {
      ...
      description:
        'Experience the "Bride of the Mediterranean" - a city where ancient wonders meet modern coastal charm. Discover the Bibliotheca Alexandrina, explore the historic Citadel of Qaitbay, and stroll along the famous Corniche.',
      price: 120,
      imageUrl: 'Alex1.jpeg',
    ...
    },
    {
      ...
      description:
        "Visit the Valley of Kings, Luxor Temple, and Karnak Temple. Experience the ancient wonders of Egypt's open-air museum.",
      price: 180,
